...
namespace ManeuverForVRC.Editor
{
    ...
    /// shipped as bitmaps.
    /// </summary>
    public class MfvVectorIcon : VisualElement
    {
        private static readonly CustomStyleProperty<Color> IconColorProperty =
            new CustomStyleProperty<Color>("--mfv-icon-color");
        ...
        public MfvVectorIcon(string pathData, Vector2 viewBox, float strokeWidth = 2f, bool fill = false)
            : this()
        {
            _viewBox = viewBox;
        ...
        public void SetPaths(params string[] pathData)
        {
            ...
            foreach (var data in pathData)
            {
                ...
                {
                    MfvSvgPath.Flatten(data, _contours, _closed);
                }
            }
    ...
    public static class MfvSvgPath
    {
