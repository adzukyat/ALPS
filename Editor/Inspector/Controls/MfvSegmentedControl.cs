...
namespace ManeuverForVRC.Editor
{
    ...
    /// </summary>
    public class MfvSegmentedControl : BaseField<int>
    {
        public new static readonly string ussClassName = "mfv-seg";

        private readonly List<Label> _items = new List<Label>();
        private readonly VisualElement _container;

        public MfvSegmentedControl(string label, params string[] options)
