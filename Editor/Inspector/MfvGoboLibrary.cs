...
namespace ManeuverForVRC.Editor
{
    ...
    public static class MfvGoboLibrary
    {
        ...
        public const int GoboCount = MfvGoboStop.MaxIndex;

        /// <summary>Gobo numbers the picker offers after OFF.</summary>
        public const int FirstPatternIndex = MfvGoboStop.OffIndex + 1;

        public static string GetName(int goboIndex)
        {
            return goboIndex <= MfvGoboStop.OffIndex || goboIndex > GoboCount ? "OFF" : Names[goboIndex - 1];
        }
