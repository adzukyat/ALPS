...
namespace ManeuverForVRC.Ui.Editor
{
    ...
    /// reports every edit through <see cref="Changed"/>, so it can be hosted by the
    /// ScriptableObject editor today and by the timeline clip inspector later.
    /// </summary>
    public class MfvClipInspectorView : VisualElement
    {
        ...
        public MfvClipInspectorView(MfvClipEffectSet set)
        {
            ...
            // --- Order ---------------------------------------------------
            var order = new MfvSegmentedControl("並び順", "通常", "左右対称", "ランダム");
