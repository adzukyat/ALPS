...
namespace ManeuverForVRC.Tests
{
    ...
    /// The gate is <see cref="MfvLayoutAuditTests"/>.
    /// </summary>
    public class MfvLayoutProbeTests
    {
        ...
        {
            var set = MfvInspectorFixture.Build();
        ...
        {
            if (element is MfvVectorIcon icon &&
            ...
            if (element is MfvPhaseGraph graph)
            {
